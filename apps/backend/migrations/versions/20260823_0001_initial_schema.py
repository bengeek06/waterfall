...
def upgrade() -> None:
    ...
    # ms_project <-> wf_planning/wf_estimate are mutually referencing: these foreign keys can only
    # be added once both target tables exist. Batch mode covers SQLite, which has no ADD CONSTRAINT.
